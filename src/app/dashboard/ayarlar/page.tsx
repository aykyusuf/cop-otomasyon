...
export default function AyarlarPage() {
  ...
  const handleResetDB = async () => {
    try {
      ...
      const data = await fetch("/api/bins").then((r) => r.json());
      if (Array.isArray(data)) init(data);
      toast.success("Simülasyon sıfırlandı");
    } catch {
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="recyclable">Geri Dönüşüm</SelectItem>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="kutuphane">Kütüphane</SelectItem>
        ...
        <div className="glass rounded-xl p-5 space-y-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={handleResetDB}>
              <RotateCcw className="w-4 h-4 mr-2" /> Simülasyonu Sıfırla
            </Button>
          </div>
        </div>
      </div>
